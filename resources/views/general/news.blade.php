        ...
        <div class="grid grid-cols-1 mb-10 mx-24 w-lg rounded overflow-hidden shadow-lg">
            ...
            @if ($news[0]->image)
                <div class="lg:h-96 overflow-hidden">
                    <img src="{{ asset('/storage/' . $news[0]->image) }}" class="w-full">
            ...
            <div class=" lg:border-gray-400 bg-white rounded-b m-6 flex flex-col justify-between leading-normal">
                <div class="mb-8">
                    <div class="text-gray-900 font-bold text-xl mb-2">{{ $news[0]->title }}</div>
                    <p class="text-gray-700 text-base">{{ $news[0]->excerpt }}</p>
                </div>
                <div class="text-sm">
                    <p class="text-gray-900 leading-none">Last Update</p>
                    <p class="text-gray-600">{{ $news[0]->created_at->diffForHumans() }}</p>
                </div>
                <div class=" pt-4 pb-2">
                    <a href="/article/{{ $news[0]->slug }}"
