<x-app-layout>
    ...
    <div class="w-full px-4">
        <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
            ...
            <a href="/dashboard/materi/create" class="flex flex-wrap gap-3 bg-cyan-900 hover:bg-cyan-600 text-white font-bold py-2 px-4 rounded m-8 w-44">
            ...
            <div class="block w-full overflow-x-auto px-8">
                ...
                <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                    ...
                    <a href="/dashboard/materi/{{ $materi->id }}">
                    ...
                    <a href="/dashboard/materi/{{ $materi->id }}/edit">
                       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-yellow-600 hover:bg-yellow-300">
                        ...
                        <div>
                            <form action="/dashboard/materi/{{ $materi->id }}" method="post">
                            @method('delete')
                            @csrf
