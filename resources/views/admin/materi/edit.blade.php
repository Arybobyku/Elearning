        ...
        <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
            ...
            <div class="block w-full overflow-x-auto">
                <form method="post" action="/dashboard/materi/{{ $materis->id }}">
                    ...
                    @csrf
                <div class="mb-6">
                    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Judul Materi</label>
                ...
                <div class="mb-6">
                    ...
                    <input type="desc" value="{{ old('desc',  $materis->desc)}}" id="desc" name="desc" class="block w-full p-2.5 bg-gray-50 border border-gray-300 text-black text-sm rounded-lg " placeholder="name@flowbite.com" required>
                </div>
