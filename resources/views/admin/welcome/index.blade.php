<x-app-layout>
    ...
    <div class="w-full px-4">
        <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
            ...
            <a href="/dashboard/welcome/create" class="flex flex-wrap gap-3 bg-cyan-900 hover:bg-cyan-600 text-white font-bold py-2 px-4 rounded m-8 w-54">
            ...
            <div class="block w-full overflow-x-auto px-8">
                ...
                <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                    ...
                    <a href="/dashboard/welcome/{{ $welcome->id }}">
                    ...
                    <a href="/dashboard/welcome/{{ $welcome->id }}/edit">
                      ...
                      <div>
                            <form action="/dashboard/welcome/{{ $welcome->id }}" method="post">
                            @method('delete')
                            @csrf
