<x-app-layout>
    ...
    <div class="w-full px-4">
        <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
            ...
            <a href="/dashboard/kuis/create" class="flex flex-wrap gap-3 bg-cyan-900 hover:bg-cyan-600 text-white font-bold py-2 px-4 rounded m-8 w-52">
            ...
            <div class="block w-full overflow-x-auto px-8">
                ...
                <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                    ...
                    <a href="/dashboard/kuis/{{ $kuis->id }}">
                        ...
                        <div>
                    <a href="/dashboard/kuis/{{ $kuis->id }}/edit">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                        ...
                        <div>
                            <form action="/dashboard/kuis/{{ $kuis->id }}" method="post">
                            @method('delete')
                            @csrf
