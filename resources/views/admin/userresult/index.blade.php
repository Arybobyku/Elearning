        ...
        <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white">
            <div class="rounded-t mb-0 px-4 py-3 border-0">
              ...
              <div>
                            ...
                            @method('delete')
                            @csrf
                            <button class="flex flex-wrap bg-red-400 px-4 py-2 ml-8 m-2 rounded-md hover:bg-red-600" onclick="return confirm('Apakah Kamu Yakin Ingin Menghapus?') ">
            ...
            <div class="block w-full overflow-x-auto px-8 pt-8">
                ...
                <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                    ...
                    <a href="/dashboard/userresult/{{ $userInput->id }}">
                        ...
                        {{-- <div>
                    <a href="/dashboard/userresult/{{ $userInput->id }}/edit">
